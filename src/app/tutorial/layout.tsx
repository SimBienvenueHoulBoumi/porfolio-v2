...
import { TutorialLoadingProvider, useTutorialLoading } from "./loading-context";
...
function TutorialLayoutContent({ children }: TutorialLayoutProps) {
  ...
  const { isReady } = useTutorialLoading();
